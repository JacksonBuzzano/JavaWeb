...
<body class="pag">
	...
	<div>
		<input class="endereço" type="text" placeholder="Endereço"name="endereço">
		<input class="número" type="number" placeholder="Número"name="número">
	...
	<div>
		...
		<input class="função" type="text" placeholder="Função"name="função">
	</div>
	<div>
