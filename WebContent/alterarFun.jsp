...
<body class="pag">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link"
					href="index.jsp">Página Inicial <span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="cadFuncionário.jsp">Cadastro de Funcionário</a></li>
				<li class="nav-item"><a class="nav-link"
	...
	<!-- Frase da tela -->
	<h2>ALTERAÇÃO DE DADOS CADASTRAIS DO TRABALHADOR</h2>

	<!-- formulário -->
	<form class="alterar" action="alterarFuncionário.jsp" method="post">
		...
		<div>
			<input type="text" placeholder="Endereço"
				value="<%out.print(f.getEndereco());%>" name="endereço"
				class="endereço"> <input type="number" placeholder="Número"
				value="<%out.print(f.getNumero());%>" name="número" class="número">
		...
		<div>
			<input type="text" placeholder="Telefone"
				...
				class="telefone"> <input type="text" placeholder="Função"
				value="<%out.print(f.getFuncao());%>" name="função" class="função">
		</div>
		<div>
